...
/* harmony import */ var _search_vue_vue_type_template_id_4cedc0c6_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./search.vue?vue&type=template&id=4cedc0c6&scoped=true& */ 38);
...
/* harmony import */ var _search_vue_vue_type_style_index_0_id_4cedc0c6_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./search.vue?vue&type=style&index=0&id=4cedc0c6&scoped=true&lang=css& */ 42);
...
//
//
var _default = { data: function data() {return { //关键词
      searchdata: '', takeshop: [] };}, methods: { //搜索按钮事件
    searchBtn: function searchBtn() {console.log(this.searchdata); //创造一个searchCoder接受关键词然后传给Post方法
      var searchCoder = this.searchdata;this.searchPost(searchCoder);}, //回车按钮事件
    onKeyInput: function onKeyInput(e) {console.log(e.detail.value); //创造一个searchCoder接受关键词然后传给Post方法
      var searchCoder = e.detail.value;this.searchPost(searchCoder);}, //发送搜索请求方法
    searchPost: function searchPost(e) {var _this = this; //因为传对象所以用data包裹
      var data = { searchdata: e };(0, _api.publicing)(_request.searchurl, data).then(function (res) {console.log(res);_this.takeshop = res.data;}).catch(function (err) {console.log(err);});} } };exports.default = _default;
